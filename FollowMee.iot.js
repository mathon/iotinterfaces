...
function getMilesFromHome(lat2, lon2) \{\
   ...
   var \uc0\u966 1 = toRad(lat1);\
   var \uc0\u966 2 = toRad(lat2);\
   var \uc0\u916 \u966  = toRad(lat2-lat1);\
   var \uc0\u916 \u955  = toRad(lon2-lon1);\
\
var a = Math.sin(\uc0\u916 \u966 /2) * Math.sin(\u916 \u966 /2) +\
        Math.cos(\uc0\u966 1) * Math.cos(\u966 2) *\
        Math.sin(\uc0\u916 \u955 /2) * Math.sin(\u916 \u955 /2);\
...
\{\
  var wsApiKey = "fe8d7c7b8ee7b9d002b3252bfcbb0393"\
  var streams = [ "fm0Name", "fm0Dfh", "fm0Time", "fm0Ldfh", "fm0Ltime", "fm0Gh"\
                ];\
  var headers =\
   \{     \
     "Content-Type": "application/json",\
     "X-M2X-KEY" : "9b1d01b314b8541c92a07d580c67f43b",    \
      "Accept":    "*/*",\
   \}\
           \
...
function getProximityData() \{\
   var url ="https://www.followmee.com/api/tracks.aspx?key=f4ed25bec5a97dd18158dbbfd77cef32&username=johnmathon&output=json&function=currentforalldevices";\
